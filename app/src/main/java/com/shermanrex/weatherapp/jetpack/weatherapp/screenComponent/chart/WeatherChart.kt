package com.shermanrex.weatherapp.jetpack.weatherapp.screenComponent.chart
...
@Composable
fun WeatherChart(
  inputList: List<ChartModel> = emptyList(),
  uppervalue: Double,
  lowervalue: Double,
  ...
  LaunchedEffect(key1 = inputList, block = {
	...
	Canvas(
	  ...
	  (inputList.indices).forEach { index ->
		drawContext.canvas.nativeCanvas.drawText(
		  timeStampFormatterChart(inputList[index].date),
